...
test("manifest stages preserve valid lane geometry and scale past twenty tracks", () => {
  ...
  assert.ok(manifest.tracks.every((track) => JSON.stringify(track.raceLine) === JSON.stringify({ startX: 114, finishX: 1977 })));
  ...
  const png = readFileSync(new URL("../assets/tracks/prehistoric-winter/prehistoric-winter-panning-background.png", import.meta.url));
